...
//compare two sets of value 
//print true or false depending on if at least one of the pair is truthy

//approach

//create a constant of 4 values
//two pairs of two values
//create an if statement on weather each pair individually are equal
//create an if statement that if at least one of the pairs is equal then print true
//if both pairs are not equal print false
