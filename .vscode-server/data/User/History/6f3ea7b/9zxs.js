...
// .2
//const coffeenames = coffeeMenu.map((record) => record.name);/console.log(coffeenames)
...
// .7
const seasonaldrinks2 = coffeeMenu.filter((record) => record.seasonal === true);

const seasonalbeans2 = seasonaldrinks.map((record) => record.name);
console.log(`${seasonalbeans} with imported beans`)
